package com.chewabletech.world.gen.feature;
...
public class OverworldGenMinable extends WorldGenerator
{
    ...
    public OverworldGenMinable(Block p_i45459_1_, int p_i45459_2_)
    {
        this(p_i45459_1_, p_i45459_2_, Blocks.stone);
    }

    public OverworldGenMinable(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_)
    {
    ...
    public OverworldGenMinable(Block block, int meta, int number, Block target)
    {
